...
def parse_args():
    ...
    help = "draw all the three chains in one column"
...
class Screen:
    ...
    def draw_vert_line(self, x, y, height, end_arraw=False):
...
class Callback:
    ...
    The widget is also a callable that behaves according to the
    widget's style
    """
    height = 5
...
class Deferred:
    ...
    def draw(self, screen, x, y):
        """
        Draw a reprensentation of the callback/errback chain
...
class FiredDeferred:
    ...
    def make_drawing_deferred(self, screen, x, y):
        ...
        firing sequence onto the given screen at the given co-ordinates
        """
        ...
        for pair in self.deferred.pairs:
            ...
            d.addCallback(callback, errback)
