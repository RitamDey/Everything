...
class PoetrySocket:
    ...
    def connectionLost(self, reason):
        ...
        reactor.stop()  # no more socket, no more poetry

    def doRead(self):
        poem = b""

        while True:
            # We're just reading everything thus blocking it
            bytes_read = self.sock.recv(1024)  # blocking call
            if not bytes_read:
        ...
        # Notify, by returning, that the socket has served its purpose
